...
from .network_bodies import BaseNet
import torch.nn as nn
from ..utils import Config, tensor, DummyBody
...
class TD3Net(nn.Module, BaseNet):
    def __init__(self,
        ...
        self.actor_params = list(
            self.actor_body.parameters()) + list(self.fc_action.parameters())
        self.critic_params = list(self.critic_body_1.parameters()) + \
            list(self.fc_critic_1.parameters()) + \
