...
# class StandardReplayMemory(object):
...
#             self.memory.append(NotImplemented)
...
class RankReplayMemory(object):
    ...
    def sample(self, batch_size):
        sorted_lst = sorted(self.memory, key=self.rank_func, reverse=True)
        return sorted_lst[:batch_size]
