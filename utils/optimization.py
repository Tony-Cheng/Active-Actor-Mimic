...
# def standard_optimization(policy_net, target_net, memory, optimizer, BATCH_SIZE=256, GAMMA=0.99, device='cuda'):
#     """
...
#     rewards = tuple(
#         (map(lambda r: torch.tensor([r], device=device), batch.reward)))
